      ...
      <HeroWalkthrough shots={shots} sectionHeightVh={100}>
        <div className="pointer-events-none absolute inset-0 z-20 flex flex-col justify-end">
          <div className="pointer-events-auto mx-auto w-full max-w-6xl px-4 pb-20 sm:px-6">
            <p
              className="text-xs font-medium tracking-widest uppercase animate-fade-in-up"
            ...
            <h1
              className="font-serif text-white animate-fade-in-up"
              style={{
            ...
            <p
              className="mt-6 text-base leading-relaxed animate-fade-in-up prose-constrained"
              style={{
            ...
            <div
              className="mt-14 grid grid-cols-2 gap-y-8 sm:grid-cols-4 animate-fade-in-up"
              style={{
...
const stats = [
  ...
  { label: "MahaRERA status", value: "Verification pending", variant: "badge" },
];
