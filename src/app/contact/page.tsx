...
export const metadata = {
  title: "Contact",
  description:
    "Book a site visit or request a callback through the project inquiry form.",
  openGraph: {
      ...
      >
        <div className="mx-auto w-full max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
          ...
          <p className="mt-4 text-base leading-7 text-muted" style={{ maxWidth: "var(--max-prose)" }}>
            Request a site visit or callback through the inquiry form. Project
            records and availability can be confirmed as part of the follow-up.
          </p>
        </div>
      </div>
            ...
            <div>
              <div className="flex items-center justify-between pb-6 mb-8" style={{ borderBottom: "1px solid var(--hairline)" }}>
                <div>
                  ...
                  <p className="text-xs text-muted mt-1">Select a preferred date and describe what you need.</p>
                </div>
              ...
              <div className="space-y-6">
                <div>
                  <div className="text-[11px] font-medium uppercase tracking-wider text-muted mb-1 flex items-center gap-2">
                    <svg className="w-3.5 h-3.5 text-terracotta" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  <span className="text-sm text-muted">{company.phone ?? verificationPending}</span>
                </div>
                ...
                <div>
                  ...
                  <span className="text-sm text-muted">{company.whatsapp ?? verificationPending}</span>
                </div>

                <div>
                  <div className="text-[11px] font-medium uppercase tracking-wider text-muted mb-1 flex items-center gap-2">
                    <svg className="w-3.5 h-3.5 text-terracotta" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a1.125 1.125 0 01-1.07-1.916V6.75" />
                    </svg>
                    Email
                  </div>
                  <span className="text-sm text-muted">{company.email ?? verificationPending}</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 sm:p-8 flex-1 flex flex-col justify-between space-y-6">
              <div>
                ...
                <div className="flex items-start gap-2.5">
                  <svg className="w-4 h-4 text-terracotta shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <p className="mt-2 text-xs leading-5 text-muted">
                  Registered office details: {verificationPending.toLowerCase()}.
                </p>
              </div>
              ...
              <div className="p-4 rounded-sm bg-surface" style={{ border: "1px solid var(--hairline)" }}>
                ...
                <div className="text-xs text-muted">
                  Scheduling details will be confirmed after your inquiry.
                </div>
              </div>
            </div>
          </aside>
