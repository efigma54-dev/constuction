    ...
    <main className="flex-1 bg-background">
      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-12 sm:px-6">
        <div className="grid gap-0 lg:grid-cols-2">
          <div className="p-8 flex flex-col justify-between" style={{ border: "1px solid var(--hairline)" }}>
            <div>
              ...
              <dl className="mt-6 grid gap-4 text-sm">
                {[
                  ...
                  { label: "Location", value: `${company.city}, ${company.state}` },
                  { label: "Registered office", value: verificationPending },
                ].map((item) => (
                  <div key={item.label} className="flex items-start justify-between gap-6 pb-4" style={{ borderBottom: "1px solid var(--hairline)" }}>
            ...
            <div className="mt-8 p-6" style={{ border: "1px solid var(--hairline)" }}>
              ...
              <p className="mt-3 text-sm leading-6 text-muted">Registration preview pending verification.</p>
            </div>
          </div>

          <div className="p-8 flex flex-col justify-between" style={{ border: "1px solid var(--hairline)", marginLeft: "-1px" }}>
            <div>
              <h2 className="font-serif text-foreground" style={{ fontSize: "var(--text-card)", lineHeight: "1.2", letterSpacing: "-0.01em" }}>
                Bank partnerships
              </h2>
              <p className="mt-4 text-sm leading-6 text-muted">
                Bank partnerships will be listed after supporting approval letters have been verified and published.
              </p>
            </div>
            <div className="mt-8 p-6" style={{ border: "1px solid var(--hairline)" }}>
              <div className="text-xs font-semibold uppercase tracking-widest text-terracotta">Approval record</div>
              <p className="mt-3 text-sm leading-6 text-muted">Approval letters will appear after verification.</p>
            </div>
          </div>
        </div>
