...
export const projects: Project[] = [
  {
    ...
    rera: "P52100001661",
    heroImage: "/images/projects/balaji-empire.jpg",
    proof: {
      existence: [
        "MahaRERA project record: P52100001661",
        "Project: BALAJI EMPIRE",
        "District: Pune · Taluka: Haveli",
      ],
      delivery: [
        "RERA proposed completion: 31 December 2018",
        "Public property records list the project as completed / ready to move",
      ],
      legitimacy: [
        "Promoter: AAKAR DEVELOPERS",
        "Promoter type: Partnership",
        "Registration date: 29 July 2017",
      ],
      transparency: [
        "RERA registration number published",
        "Project configuration published in public records",
        "Land area recorded as 814.39 sq m",
      ],
      people: [
        "RERA promoter members: Vijay Popatrao Shinde and Ratilal Onkar More",
        "Public RERA record lists appointed project professionals",
      ],
    },
    floorPlan: {
    ...
    milestones: [
      {
        stage: "RERA registration",
        promisedDate: "29 July 2017",
        actualDate: "29 July 2017",
        status: "done",
        photos: [],
        detail: "Public RERA records list the project registration date as 29 July 2017.",
      },
      {
        stage: "Project completion",
        promisedDate: "31 December 2018",
        actualDate: "31 December 2018",
        status: "done",
        photos: [],
        detail: "The public RERA record lists the proposed completion date as 31 December 2018; property records subsequently list the project as completed.",
      },
    ],
  },
  {
    ...
    description:
      "A completed AAKAR DEVELOPERS project identified in the promoter's publicly available past-experience record associated with Balaji Empire.",
    ...
    heroImage: null,
    proof: {
      existence: ["Listed as promoter past experience in the Balaji Empire record"],
      delivery: ["Status recorded as completed"],
      legitimacy: ["Promoter: AAKAR DEVELOPERS"],
      transparency: ["Detailed project registration record not yet attached"],
      people: [],
    },
